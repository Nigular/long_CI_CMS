                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            ...
                            <div class="widget-body am-fr">
                                ...
                                <form class="am-form tpl-form-border-form tpl-form-border-br" action="<?php echo base_url('manage_adsense/addone'); ?>" method="post" enctype="multipart/form-data">
                                    <div class="am-form-group">
                                        <label for="ad-title" class="am-u-sm-3 am-form-label">广告标题 <span class="tpl-form-line-small-title">Title</span></label>
                                        <div class="am-u-sm-9">
                                            <input type="text" name="title" class="tpl-form-input" id="ad-title" placeholder="请输入标题文字">
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <textarea class="" rows="5" name="desc" placeholder="请输入简单描述300字内"></textarea>
                                        </div>
                                    </div>
                                        ...
                                        <div class="am-u-sm-9" style="cursor: pointer;">
                                            <div class="am-form-group am-form-file" >
                                                <div class="tpl-form-file-img">
                                                    <img src="<?php echo base_url('assets');?>/img/a5.png" alt="" id="preview" style="max-width:100%;"/>
                                                </div>
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" name="link" placeholder="填写跳转的链接">
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" name="sort" placeholder="填写排序数字，数字越大越靠前">
